		...
		<section id="<?php if ( ta_option( 'id_about' ) != '') :  echo ta_option( 'id_about' ); ?><?php endif; ?>" class="about-section whiteBg">
			<div class="container">
				<div class="row">
					...
					?>
					<div id="about-item" class="col-md-12 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="<?php echo ($i-1)*250,'ms'; ?>">
					...
					<div class="contact-form col-md-6 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
						<form id="contact-form" method="post" action="sendmail.php" role="form">
							...
							<div class="form-group">
								<input type="text" placeholder="<?php _e( 'Your Name', 'ta-meghna' ); ?>" class="form-control" name="name" id="name">
							</div>

							<div class="form-group">
								<input type="email" placeholder="<?php _e( 'Your Email', 'ta-meghna' ); ?>" class="form-control" name="email" id="email">
							</div>

							<div class="form-group">
								<input type="text" placeholder="<?php _e( 'Subject', 'ta-meghna' ); ?>" class="form-control" name="subject" id="subject">
							</div>

							<div class="form-group">
								<textarea rows="6" placeholder="<?php _e( 'Message', 'ta-meghna' ); ?>" class="form-control" name="message" id="message"></textarea>
							</div>

							<div id="mail-success" class="success">
								<?php _e( 'Thank you. The Mailman is on his way!', 'ta-meghna' ); ?>
							</div>

							<div id="mail-fail" class="error">
								<?php _e( "Sorry, don't know what happened. Try later!", 'ta-meghna' ); ?>
							</div>
